						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input class="form-control" id="inputEmail3" disabled="disabled"
									type="text" value="${currentFarmer.username}">
							</div>
						</div>
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<div class="radio col-md-6">
								...
								<input name="sex" id="sex"
									value="男" type="radio" ${currentFarmer.sex=='男'?'checked':''}> 男
								</label> <label> <input name="sex" id="sex"
									value="女" type="radio" ${currentFarmer.sex=='女'?'checked':''}> 女
								</label>
							</div>
						</div> 
				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<textarea class="form-control" rows="3">${currentFarmer.address }</textarea>
							</div>
						</div>
						<div class="form-group">
