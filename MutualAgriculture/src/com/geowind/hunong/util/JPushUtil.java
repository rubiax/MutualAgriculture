...
public class JPushUtil {
    ...
    public static JPushClient jpushClient = new JPushClient(FinalString.MASTERSECRET, FinalString.APPKEY, 3);;  
      
	public static void sendPush(String alias,String title,String content) {  
          
        PushPayload payload=buildPushObject_android_and_iosByAlias(alias,title,content);
        try {  
